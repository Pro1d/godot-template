...
func _ready() -> void:
	...
	_front_closed_occluders[-1].a = t2 * Vector2(.5, -.5)
	_front_closed_occluders[-1].b = t2 * Vector2(.5, .5)
	_back_closed_occluders[-1].a = _front_closed_occluders[-1].b
	_back_closed_occluders[-1].b = _front_closed_occluders[-1].a
